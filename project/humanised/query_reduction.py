"""Run the original query-reduction experiment inside `humanised/`."""
...
ORIGINAL_SCRIPT = VENDOR_DIR / "chandan" / "query_reduction" / "run_experiments.py"
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "output_query_reduction"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Humanised query-reduction wrapper")
    ...
    print("Query-reduction outputs written to:", output_dir)
