...
| 39 | embedding_tfidf | 2 | 1257, 1264, 272, 37, 43 |
...
| 40 | embedding_tfidf | 2 | 1257, 536, 37, 1141, 976 |
| 40 | embedding_lsa | 2 | 1141, 1257, 536, 37, 272 |
| 40 | embedding_esa | 2 | 1257, 536, 37, 1141, 976 |
| 40 | embedding_word2vec | 2 | 536, 1141, 1257, 37, 272 |
| 51 | baseline_tfidf | 4 | 326, 494, 23, 94, 1301 |
| 51 | wordnet | 4 | 326, 494, 23, 94, 1301 |
| 51 | embedding_tfidf | 3 | 326, 494, 1301, 23, 1214 |
| 51 | embedding_lsa | 4 | 326, 494, 1301, 23, 94 |
| 51 | embedding_esa | 3 | 326, 494, 1301, 23, 1214 |
| 51 | embedding_word2vec | 4 | 494, 326, 1301, 23, 94 |
| 64 | baseline_tfidf | 2 | 878, 391, 52, 390, 593 |
| 64 | wordnet | 2 | 391, 878, 52, 593, 390 |
| 64 | embedding_tfidf | 2 | 391, 878, 1252, 390, 52 |
| 64 | embedding_lsa | 1 | 878, 391, 1252, 52, 593 |
| 64 | embedding_esa | 2 | 391, 878, 390, 1252, 52 |
| 64 | embedding_word2vec | 2 | 391, 878, 390, 52, 593 |
| 81 | baseline_tfidf | 1 | 652, 206, 249, 799, 714 |
| 81 | wordnet | 1 | 652, 206, 249, 799, 714 |
| 81 | embedding_tfidf | 1 | 206, 652, 249, 714, 799 |
| 81 | embedding_lsa | 1 | 206, 652, 799, 249, 714 |
| 81 | embedding_esa | 1 | 206, 652, 714, 249, 799 |
| 81 | embedding_word2vec | 1 | 206, 652, 249, 714, 799 |
...
| slip-flow heat transfer in internal channels | 9 | embedding_lsa | 1 | 550, 941, 270, 102, 571 |
...
| transition detection in hypersonic wakes behind slender bodies | 40 | embedding_lsa | 2 | 1141, 976, 154, 289, 536 |
| transition detection in hypersonic wakes behind slender bodies | 40 | embedding_esa | 2 | 1141, 976, 289, 154, 536 |
| transition detection in hypersonic wakes behind slender bodies | 40 | embedding_word2vec | 2 | 1141, 1196, 976, 154, 536 |
...
| replace vibrational shapes with static deflection shapes for flutter prediction | 64 | embedding_word2vec | 1 | 391, 878, 593, 1008, 1111 |
...
| shock-induced boundary-layer separation | 90 | embedding_lsa | 3 | 265, 311, 1367, 996, 1187 |
...
| what corrections are needed for a liftbody in a propwash flowfield inside a test duct | 81 | embedding_lsa | 0 | 669, 450, 607, 1270, 653 |
